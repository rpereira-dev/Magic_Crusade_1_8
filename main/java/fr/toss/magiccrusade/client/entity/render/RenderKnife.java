...
{
    private static final ResourceLocation arrowTextures = new ResourceLocation("magiccrusade:textures/entity/Knife.png");
    private static final String __OBFID = "CL_00000978";

    public RenderKnife(RenderManager p_i46193_1_)
    {
        super(p_i46193_1_);
    }
